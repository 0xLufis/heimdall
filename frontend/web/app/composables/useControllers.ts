...
export const useControllers = () => {
  const controllers = useState<IndustrialController[]>('global_controllers', () => [])
  const selectedController = useState<IndustrialController | null>('global_selected_controller', () => null)
