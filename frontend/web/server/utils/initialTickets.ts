/**
 * Initial seed tickets for the maintenance Kanban board.
 *
 * Extracted from ticketsStore.ts to keep the store module focused on
 * CRUD operations while this file owns the demo/seed data.
 */
import type { MaintenanceTicket } from './ticketsStore'
