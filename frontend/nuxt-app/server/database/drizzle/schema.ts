...
export const verification = hbSchema.table(
  "verification",
  {
    id: text("id").primaryKey(),
...
export const organization = hbSchema.table("organization", {
  id: text("id").primaryKey(),
  name: text("name").notNull(),
...
export const member = hbSchema.table("member", {
  id: text("id").primaryKey(),
...
export const invitation = hbSchema.table("invitation", {
  id: text("id").primaryKey(),
  organizationId: text("organization_id")
    .notNull()
    .references(() => organization.id, { onDelete: "cascade" }),
