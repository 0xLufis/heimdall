...
namespace App.Shared.Migrations
{
    ...
    [Migration("20260912005249_InventorySegmentationAndParts")]
    partial class InventorySegmentationAndParts
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("App.Shared.Entities.AdOuGovernance", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasKey("Id")
                        .HasName("pk_ad_ou_governances");

                    b.ToTable("ad_ou_governances", "backend");
                });
            ...
            modelBuilder.Entity("App.Shared.Entities.BaseInventoryItem", b =>
                {
                    ...
                    b.HasIndex("MachineId")
                        .HasDatabaseName("ix_inventory_items_machine_id");
            ...
            modelBuilder.Entity("App.Shared.Entities.ClientCertificateRecord", b =>
                {
                    ...
                    b.Property<string>("AdOuPath")
                        .HasMaxLength(500)
                        .HasColumnType("character varying(500)")
                        .HasColumnName("ad_ou_path");
                    ...
                    b.Property<string>("RawPem")
                        .HasColumnType("text")
                        .HasColumnName("raw_pem");
            ...
            modelBuilder.Entity("App.Shared.Entities.ClientPc", b =>
                {
                    ...
                    b.Property<string>("CertificateProfileName")
                        .HasMaxLength(128)
                        .HasColumnType("character varying(128)")
                    ...
                    b.Property<JsonDocument>("OuTags")
                        .HasColumnType("jsonb")
                        .HasColumnName("ou_tags");
            ...
            modelBuilder.Entity("App.Shared.Entities.OuCertificateRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.Property<int>("ValidityYears")
                        .HasColumnType("integer")
                        .HasColumnName("validity_years");

                    b.HasKey("Id")
                        .HasName("pk_ou_certificate_rules");

                    b.HasIndex("OuPath")
                        .HasDatabaseName("ix_ou_certificate_rules_ou_path");

                    b.ToTable("ou_certificate_rules", "backend");
                });
            ...
            modelBuilder.Entity("App.Shared.Entities.Machine", b =>
                {
                    ...
                    b.Property<string>("PreferredTechnicianId")
                        .HasColumnType("text")
                        .HasColumnName("preferred_technician_id");

                    b.Property<string>("PreferredTechnicianName")
                        .HasColumnType("text")
                        .HasColumnName("preferred_technician_name");
            ...
            modelBuilder.Entity("App.Shared.Entities.BaseInventoryItem", b =>
                {
                    ...
                    b.HasOne("App.Shared.Entities.Machine", "Machine")
                        ...
                        .OnDelete(DeleteBehavior.SetNull)
                        .HasConstraintName("fk_inventory_items_stations_machine_id");
